define([
    'utils/helpers',
    'text!templates/rightclick.html',
    'utils/underscore',
    'utils/ui',
], function(utils, rightclickTemplate, _, UI) {
    ...
    _.extend(RightClick.prototype, {
        buildArray : function() {
            ...
            var metadata = 'local.' + now.toISOString().replace(/[\.\-:T]/g, '-').replace(/Z|\.\d/g, '');
            var version='1.1.0'+'+'+metadata;
        ...
        buildMenu : function() {
            ...
            return utils.createElement(rightclickTemplate);
        },
        updateHtml : function() {
        ...
        showMenu : function(evt) {
            ...
            utils.addClass(this.playerElement, 'js-flag-rightclick-open');
        ...
        hideMenu : function() {
            ...
            utils.removeClass(this.playerElement, 'js-flag-rightclick-open');
