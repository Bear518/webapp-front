...
module.exports.css = function(el, cssName, cssVal) {
  if(el.className.indexOf('animation')>-1){
    delete cssName.left;  
  }
...
module.exports.IS_MOBILE = module.exports.IS_IOS || module.exports.IS_ANDROID || !module.exports.HAS_FLASH;
...
var BigPlayButton = Component.extend({
	init: function  (player, options) {
		...
		this.addClass(options.className || 'prism-big-play-btn animation');
	},
...
var Progress = Component.extend({
    ...
    _onMouseClick: function(e) {
        ...
        var offsetLeft=this.el().offsetLeft||this.el().getBoundingClientRect().left;
